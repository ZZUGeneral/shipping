...
public class Producer {
    ...
    public static void waterLevel() {
        ...
        try {
            ...
            timer.schedule(new SendTask(wlc1, waterLevelMessage, Const.TOPIC_W1), 0, 1500);
            timer.schedule(new SendTask(wlc2, waterLevelMessage, Const.TOPIC_W2), 0, 1500);
            timer.schedule(new SendTask(wlc3, waterLevelMessage, Const.TOPIC_W3), 0, 1500);
            timer.schedule(new SendTask(wlc4, waterLevelMessage, Const.TOPIC_W4), 0, 1500);
    ...
    public static void tilt() {
        ...
        try {
            ...
            timer.schedule(new SendTask(wlc1, tiltMessage, Const.TOPIC_T1), 0, 1500);
            // timer.schedule(new SendTask(wlc2, tiltMessage, Const.TOPIC_T2), 0, 1500);
            timer.schedule(new SendTask(wlc3, tiltMessage, Const.TOPIC_T3), 0, 1500);
            // timer.schedule(new SendTask(wlc4, tiltMessage, Const.TOPIC_T4), 0, 1500);
            timer.schedule(new SendTask(wlc5, tiltMessage, Const.TOPIC_T5), 0, 1500);
            // timer.schedule(new SendTask(wlc6, tiltMessage, Const.TOPIC_T6), 0, 1500);
            timer.schedule(new SendTask(wlc7, tiltMessage, Const.TOPIC_T7), 0, 1500);
            // timer.schedule(new SendTask(wlc8, tiltMessage, Const.TOPIC_T8), 0, 1500);
        } catch (MqttException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void angle() {
        ...
        try {
            ...
            timer.schedule(new SendTask(mqttClient1, angleMessage, Const.TOPIC_A1), 0, 1500);
            timer.schedule(new SendTask(mqttClient2, angleMessage, Const.TOPIC_A2), 0, 1500);
            timer.schedule(new SendTask(mqttClient3, angleMessage, Const.TOPIC_A3), 0, 1500);
            timer.schedule(new SendTask(mqttClient4, angleMessage, Const.TOPIC_A4), 0, 1500);
        } catch (MqttException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void vibration() {
        ...
        try {
            ...
            timer.schedule(new SendTask(mqttClient1, vibrationMessage, Const.TOPIC_V1), 0, 1500);
            timer.schedule(new SendTask(mqttClient2, vibrationMessage, Const.TOPIC_V2), 0, 1500);
            timer.schedule(new SendTask(mqttClient3, vibrationMessage, Const.TOPIC_V3), 0, 1500);
            timer.schedule(new SendTask(mqttClient4, vibrationMessage, Const.TOPIC_V4), 0, 1500);
        } catch (MqttException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void weather() {
        ...
        try {
            ...
            timer.schedule(new SendTask(wlc1, weatherGeneralMessage, Const.TOPIC_WEATHER1), 0, 1500);
            timer.schedule(new SendTask(wlc2, weatherRainfallMessage, Const.TOPIC_WEATHER2), 0, 1500);
            timer.schedule(new SendTask(wlc3, weatherVisibilityMessage, Const.TOPIC_WEATHER3), 0, 1500);
        } catch (MqttException e) {
            e.printStackTrace();
        }
    }
